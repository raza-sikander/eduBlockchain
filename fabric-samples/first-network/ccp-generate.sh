...
P1PORT=8051
CAPORT=7054
PEERPEM=crypto-config/peerOrganizations/edu1MSP/tlsca/tlsca.edu1MSP-cert.pem
CAPEM=crypto-config/peerOrganizations/edu1MSP/ca/ca.edu1MSP-cert.pem
...
P1PORT=10051
CAPORT=8054
PEERPEM=crypto-config/peerOrganizations/edu2MSP/tlsca/tlsca.edu2MSP-cert.pem
CAPEM=crypto-config/peerOrganizations/edu2MSP/ca/ca.edu2MSP-cert.pem
